...
notice: if you want to receive and send messages in one goroutine, be sure that it was maked from different net.Connection interfaces; otherwise there will be problems :(
