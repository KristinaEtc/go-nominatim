...
from placex WHERE ST_DWithin(ST_SetSRID(ST_Point(27.600286,'53.913658'),4326), geometry, 0.004)
...
OR ST_DWithin(ST_SetSRID(ST_Point('27.600286','53.913658'),4326), centroid, 10))
ORDER BY ST_distance(ST_SetSRID(ST_Point('27.600286','53.913658'),4326),geometry) ASC limit 1
